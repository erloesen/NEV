<template>
      ...
      <div class="table-header">
        <div class="search-wrapped">
          <el-input
              ...
              placeholder="输入用户名"
              :suffix-icon="Search"
              @change="searchSU(searchAccount, 2)"
          />
        </div>
        <div class="button-wrapped">
          <el-button type="primary" @click="openCreate(2)">添加用户</el-button>
        </div>
      </div>
  ...
  <createSuperUser ref="Create" @success="getSUlist(2)"></createSuperUser>
  <editSuperUser ref="Edit" @success="getSUlist(2)"></editSuperUser>
  <deleteSuperUser ref="Delete" @success="getSUlist(2)"></deleteSuperUser>
</template>
